(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('blockstack'), require('react'), require('@blockstack/ui'), require('use-events'), require('styled-components'), require('jsontokens'), require('@blockstack/stacks-transactions'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'blockstack', 'react', '@blockstack/ui', 'use-events', 'styled-components', 'jsontokens', '@blockstack/stacks-transactions', 'react-dom'], factory) :
  (global = global || self, factory(global['@blockstack/connect'] = {}, global.blockstack, global.React, global.ui, global.useEvents, global.Styled, global.jsontokens, global.stacksTransactions, global.ReactDOM));
}(this, (function (exports, blockstack, React, ui, useEvents, Styled, jsontokens, stacksTransactions, ReactDOM) { 'use strict';
  ...
  var getOrCreateUserSession = function getOrCreateUserSession(userSession) {
    if (!userSession) {
      var appConfig = new blockstack.AppConfig(['store_write'], document.location.href);
  ...
  var signPayload = function signPayload(payload, privateKey) {
    try {
      var tokenSigner = new jsontokens.TokenSigner('ES256k', privateKey);
  ...
  var makeContractCallToken = function makeContractCallToken(opts) {
    try {
      ...
      var args = functionArgs.map(function (arg) {
        ...
        return stacksTransactions.serializeCV(arg).toString('hex');
      });
  ...
  var Intro = function Intro() {
    ...
    }, "Get your Secret Key")), React__default.createElement(ScreenFooter, null, React__default.createElement(ui.Stack, {
      mb: "base-loose",
      mt: "base-tight",
      spacing: "base",
      isInline: true
    ...
    }, "Sign in"), React__default.createElement(Link, {
      color: "blue",
      textStyle: "caption",
      onClick: function onClick() {
        doGoToHowItWorksScreen();
      }
    }, "How it works"), React__default.createElement(Link, {
      color: "blue",
      textStyle: "caption",
      onClick: function onClick() {
  ...
  exports.buildEnterKeyEvent = buildEnterKeyEvent;
