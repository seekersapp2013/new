...
function startServer(options) {
    ...
    connection.onInitialize((evt) => {
        ...
        configManager.update(((_d = evt.initializationOptions) === null || _d === void 0 ? void 0 : _d.config) || {});
        configManager.updateTsJsUserPreferences(((_e = evt.initializationOptions) === null || _e === void 0 ? void 0 : _e.typescriptConfig) || {});
        configManager.updateEmmetConfig(((_f = evt.initializationOptions) === null || _f === void 0 ? void 0 : _f.emmetConfig) || {});
        configManager.updatePrettierConfig(((_g = evt.initializationOptions) === null || _g === void 0 ? void 0 : _g.prettierConfig) || {});
        pluginHost.initialize({
            filterIncompleteCompletions: !((_h = evt.initializationOptions) === null || _h === void 0 ? void 0 : _h.dontFilterIncompleteCompletions),
            definitionLinkSupport: !!((_k = (_j = evt.capabilities.textDocument) === null || _j === void 0 ? void 0 : _j.definition) === null || _k === void 0 ? void 0 : _k.linkSupport)
        });
        ...
        const clientSupportApplyEditCommand = !!((_l = evt.capabilities.workspace) === null || _l === void 0 ? void 0 : _l.applyEdit);
        return {
            capabilities: {
                textDocumentSync: {
                    openClose: true,
                ...
                codeActionProvider: ((_o = (_m = evt.capabilities.textDocument) === null || _m === void 0 ? void 0 : _m.codeAction) === null || _o === void 0 ? void 0 : _o.codeActionLiteralSupport) ? {
                    codeActionKinds: [
                ...
                executeCommandProvider: clientSupportApplyEditCommand
                    ...
                    : undefined,
                renameProvider: ((_q = (_p = evt.capabilities.textDocument) === null || _p === void 0 ? void 0 : _p.rename) === null || _q === void 0 ? void 0 : _q.prepareSupport) ? { prepareProvider: true }
                    : true,
    ...
    connection.onSignatureHelp((evt) => pluginHost.getSignatureHelp(evt.textDocument, evt.position, evt.context));
